...
- Дерево строится из путей, объявленных в `.project/manifest.yaml`, а не из хардкод-директорий.
- Иконки статусов соответствуют ровно пяти статусам, определённым в `planning/EXECUTION_PROTOCOL.md`.
