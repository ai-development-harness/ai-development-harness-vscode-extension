...
|---|---|---|---|---|
| [REQ-001](REQ-001-command-palette.md) | Command Palette с канонической командной поверхностью | Частично | STEP-005, STEP-009, STEP-024 | Предыдущее evidence действительно только для legacy layout; `STEP-024` восстанавливает совместимость с current control-plane `.harness/**`. |
| [REQ-002](REQ-002-sidebar-explorer.md) | Sidebar Explorer артефактов проекта | Частично | STEP-006, STEP-015, STEP-016, STEP-024 | Предыдущее evidence действительно только для legacy layout; `STEP-024` восстанавливает совместимость с current control-plane `.harness/**`. |
| [REQ-003](REQ-003-step-editor.md) | Smart-редактор STEP-файлов | Частично | STEP-007, STEP-016, STEP-021, STEP-022, STEP-023, STEP-024 | Предыдущее evidence действительно только для legacy layout; `STEP-024` восстанавливает совместимость с current control-plane `.harness/**`. |
