...
1. Прочитай `.project/manifest.yaml`, включая `language`; если initialized=true, остановись и предложи `PROJECT RECONCILE`. После общих repository instructions также прочитай `AGENTS.local.md`, если он существует.
